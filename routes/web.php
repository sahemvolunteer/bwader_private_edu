...
Route::get('/students/{class_id}/{section_id}', 'StudentRecordController@listBySection')->name('students.list.section');//section
        ...
        Route::get('/subjects/{subject}/assign_teacher', 'SubjectController@assignTeacher')->name('subjects.assign_teacher');
        Route::Post('/subjects/{subject}/assign_teacher/save', 'SubjectController@saveassignTeacher')->name('subjects.assign_teacher.save');
