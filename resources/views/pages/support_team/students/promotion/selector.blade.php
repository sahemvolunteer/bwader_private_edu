    ...
    <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="fc" class="col-form-label font-weight-bold">من الصف :</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="fs" class="col-form-label font-weight-bold">من الشعبة :</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="tc" class="col-form-label font-weight-bold">إلى الصف:</label>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="ts" class="col-form-label font-weight-bold">الشعبة :</label>
        ...
        <div class="col-md-2 mt-4">
            <div class="text-right mt-1">
                <button type="submit" class="btn btn-primary">إدارة الترفع <i class="icon-paperplane ml-2"></i></button>
            </div>
        </div>
