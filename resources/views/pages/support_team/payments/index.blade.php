...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title"> {{ __('msg.select') }}
 </h5>
            {!! Qs::getPanelOptions() !!}
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="form-group">
                                    <label for="year" class="col-form-label font-weight-bold">{{ __('msg.select') }} <span class="text-danger">*</span></label>
                                    <select data-placeholder={{ __('msg.select') }} required id="year" name="year" class="form-control select">
                                        @foreach($years as $yr)
...
@if($selected)
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title"> {{ __('msg.mangpayments') }} {{ __('msg.session') }} {{ $year }}  </h6>
            {!! Qs::getPanelOptions() !!}
        </div>
